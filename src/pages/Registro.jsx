...
export default function Register() {
  ...
  const onSubmit = async (e) => {
    ...
    const userData = {
      ...
      isDuoc: /@duocuc\.cl$/i.test(normalizedEmail),
      felicesCincuenta: (cupon || "").trim().toUpperCase() === "FELICES50",
    ...
    try {
      ...
      if (
        ...
        backendError.includes("SQLIntegrityConstraintViolationException")
      ) {
        setError(
